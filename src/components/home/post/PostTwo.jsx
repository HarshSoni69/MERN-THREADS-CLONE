   ...
   <>
    <Stack flexDirection={'column'} justifyContent={'space-between'}>
      <Stack flexDirection={'column'} gap={2}>
        ...
        <img src='/error-bg.png' alt='' loading='lazy' 
        width={_700 ? "400px":_500 ? "350px" : _400 ? '250px' : _300 ? "180px" : "150px"}  height={'auto'} />
      </Stack>
      <Stack flexDirection={'column'} gap={1}>
        ...
        <Stack flexDirection={'row'} gap={1} position={'relative'} top={-3} left={4}>
          <Typography variant='caption' color={'GrayText'} fontSize={_700 ? '1.1rem' : "0.9rem"} >2 likes.</Typography>
          <Typography variant='caption' color={'GrayText'} fontSize={_700 ? '1.1rem' : "0.9rem"} >1 comment</Typography>
        </Stack>
      </Stack>
    </Stack>
   </>
