   ...
   <>
    <Stack flexDirection={'column'} justifyContent={'space-between'}>
      <Stack flexDirection={'column'} gap={2}>
        ...
        <Typography variant='h6' fontSize={'1rem'} fontWeight={'bold'}>Harsh Soni</Typography>
        <Typography variant='h5' fontSize={'1.2rem'} >Hi guyz i made this project please like and comment on this post
        </Typography>
        </Stack>
